...
write_csv(gfs_inter, "./intersected_genes_gfs.csv")
...
write_csv(limma_inter, "./intersected_genes_limma.csv")
...
deg_GSE43358 <- read_csv("NTU_BMDS/BS6202_Techniques_in_Biomedical_Data_Mining/Group project/deg_GSE43358_cls_qn.csv")
